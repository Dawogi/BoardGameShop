...
namespace OgielBoardGamesShop.Migrations
{
    ...
    [Migration("20201107175501_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OgielBoardGamesShop.Models.BoardGame", b =>
                {
            ...
            modelBuilder.Entity("OgielBoardGamesShop.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OgielBoardGamesShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("OgielBoardGamesShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("OgielBoardGamesShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("OgielBoardGamesShop.Models.BoardGame", b =>
                {
                    b.HasOne("OgielBoardGamesShop.Models.Category", "Category")
                        .WithMany("BoardGames")
            ...
            modelBuilder.Entity("OgielBoardGamesShop.Models.OrderDetail", b =>
                {
                    b.HasOne("OgielBoardGamesShop.Models.BoardGame", "BoardGame")
                        .WithMany()
                        .HasForeignKey("BoardGameId");

                    b.HasOne("OgielBoardGamesShop.Models.Order", "Order")
